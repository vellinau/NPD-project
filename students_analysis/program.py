...
parser.add_argument('schools_path', type=str, help='path to .xlsx file with schools data',
                    default='data\\Wykaz_szkół_i_placówek_wg_stanu_na_30.IX._2018_w.5.xlsx')
parser.add_argument('population_path', type=str, help='path to directory with population data',
                    default='data\\Ludność. Stan i struktura_30.06.2020')
parser.add_argument('outpath_gmina', type=str, help='where to save results of per teacher '
                                                    'analysis, for each gmina',
                    default='results\\gmina_per_teacher.xlsx')
parser.add_argument('outpath_gminatype', type=str, help='where to save results of per teacher '
                                                        'analysis, in total',
                    default='results\\gminatype_per_teacher.xlsx')
parser.add_argument('outpath_per_age', type=str, help='where to save results of per age '
                                                      'analysis, in total',
